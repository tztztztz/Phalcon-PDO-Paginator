...
class PDOPaginator extends \Phalcon\Paginator\Adapter\AbstractAdapter {
  ...
  /**
   * Count hint instead of $sqlCount
   * 
   * @var int 
   */
  protected $countHint;
   ...
   * 'count_hint' - number of expected rows generated by the 'sql' select statement
   * 
   * @param array $config
   */
  public function __construct(array $config) {
    ...
    if (isset($config['count_hint']) && is_numeric($config['count_hint']) && $config['count_hint'] >= 0) {
      $this->countHint = $config['count_hint'];
    }
  ...
  public function paginate(): \Phalcon\Paginator\RepositoryInterface {
    ...
    try {
      ...
      if (is_numeric($this->countHint)) {
        $totalItems = $this->countHint;
      }
      else if (!empty($this->sqlCount)) {
